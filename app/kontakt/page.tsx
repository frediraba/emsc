...
export default function KontaktPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24">
        ...
        {JSON.stringify({
          ...
          itemListElement: [
            ...
            },
            {
              ...
              position: 2,
              name: "Kontakt",
              item: (process.env.NEXT_PUBLIC_SITE_URL || "https://example.com") + "/kontakt",
            },
          ],
        })}
      </Script>
      ...
      <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">Võta ühendust</h1>
      <p className="text-foreground/80 mt-3">
        Kirjelda oma üritust ja ajakava. Mida täpsem info, seda kiiremini saame pakkumise koostada.
        Vastame tavaliselt ühe tööpäeva jooksul.
      </p>
      ...
      <div className="mt-8 grid gap-4 rounded-lg border p-6">
        ...
        <div className="text-foreground/80 flex flex-col gap-1">
          <p>
            Telefon:{" "}
            <a className="underline" href="tel:+37256946300">
              5694 6300
            </a>
          </p>
          <p>
            E-post:{" "}
            <a className="underline" href="mailto:heiki@tuletaltsutaja.ee">
      ...
      <div className="mt-10 rounded-lg border p-6">
        ...
        <p className="text-foreground/80 mt-2">
          Kui vormiga tekib tõrkeid, helista või saada e-kiri ülaltoodud aadressile – vastame
          esimesel võimalusel.
        </p>
      </div>
    </main>
